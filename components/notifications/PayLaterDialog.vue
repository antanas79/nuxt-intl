    ...
    <v-dialog v-model="dialog" max-width="550">
      <v-card>
        ...
        <v-card-text class="pb-0">
          ...
          <p class="mb-0">
            <b>If Easy Pay method is selected, you will be charged each 2 weeks</b> You will then be receiving bi-weekly billing statements with payment due and
            a remaining balance of your order
          </p>
        </v-card-text>
        <v-card-actions>
          <v-spacer></v-spacer>
