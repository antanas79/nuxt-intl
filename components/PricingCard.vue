<template>
  <Card :maxWidth="maxWidth" :cols="cols" :cardClass="cardClass" :colsMd="colsMd" :colsSm="colsSm" :isPricingCard="true">
      ...
      <v-card-text class="text-subtitle-1 pt-3 pb-0">
        <div class="d-flex flex-wrap">
          ...
          <Button
            ...
            :isOutlined="true"
            :isText="true"
            buttonClassName="d-sm-none d-flex align-self-end ml-auto text-caption"
